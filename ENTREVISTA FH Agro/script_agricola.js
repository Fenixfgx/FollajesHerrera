...
const GOOGLE_SHEETS_CONFIG = {
    scriptUrl: 'https://script.google.com/macros/s/AKfycbzH-NLv9keQKF8N_hkQS1ktpxyF8BijV4ltd6ieK-CbmD9vor0B9QQGjCLtGHvI8Pgs/exec',
...
function analyzeLifestyleTrait(answer) {
    ...
    switch(trait) {
        ...
        case 'clean':
            ...
            psychProfile.alcoholism += (value / 10) * (-1);
            break;
        case 'violent':
...
function showConfigurationStatus() {
    ...
    console.log('🧠 Detección de trastornos: Psicopatía, Sociopatía, Narcisismo, Antisocial');
    console.log('🍷 Detección de adicciones: Alcohol, Drogas, Sustancias');
